package com.mengxi.mengxi_android.update;
        ...
        new Thread() {
            public void run() {
                try {
                    ...
                    // ParseXmlService.class.getClassLoader().getResourceAsStream(MengxiUtil.VERSION_URL);

                    URL url = new URL(MengxiUtil.VERSION_URL);
